...
const NavBar = () => {
  return (
    <div className='w-full'>
      <div className='flex flex-row flex-wrap justify-between z-10 pt-10 mb-5'>
        <Link href='/' className='hover:underline shadow-lg underline-offset-4 hover:shadow-blue-500/100'>Home</Link>
        <Link href='/About' className='hover:underline shadow-lg underline-offset-4 hover:shadow-green-500/100'>About</Link>
